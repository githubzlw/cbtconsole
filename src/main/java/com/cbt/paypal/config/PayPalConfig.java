...
//        final String LIVE_CLIENT_SECRET = PropertyUtils.getValueFromPaypelFile("LIVE_CLIENT_SECRET");
        ...
        final String LIVE_CLIENT_ID = GetConfigureInfo.getValueByPapPal("LIVE_CLIENT_ID");
        final String LIVE_CLIENT_SECRET = GetConfigureInfo.getValueByPapPal("LIVE_CLIENT_SECRET");
