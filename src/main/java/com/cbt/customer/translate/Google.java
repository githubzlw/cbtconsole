...
public class Google {
	 ...
	 * @return 翻译结果JSON字符串
	 */
	public static String translate(String value, String src, String target,boolean flag) {
		...
		/*return WebRequest.get("http://translate.google.cn/translate_a/t?"
				+ form.toString(), "UTF-8");*/
		return WebRequest.post("http://translate.google.cn/translate_a/t?"
				,form.toString(), "UTF-8");
/*		return WebRequest.get("http://translate.google.com/translate?depth=2&ie=UTF8&nv=1&rurl=translate.google.com&sl=zh-CN&tl=en&u=http://www.taobao.com/", "UTF-8");*/
	}
