...
public class ShopUrlDaoImpl implements IShopUrlDao {
    ...
    public List<ShopUrl> findAll(String shopId, String shopBrand, String shopUserName, String date, int start, int end, String timeFrom,
        ...
        String sql = "select a.*,(select count(b.id) from cross_border.custom_benchmark_ready_newest b " +
                "where b.shop_id =a.shop_id) as total_data_num,(select count(b.id) from cross_border.custom_benchmark_ready_newest b where b.shop_id =a.shop_id and b.valid =1) as on_line_num, au.file_name au_file_name, au.file_url au_file_url, " +
        ...
        try {
            ...
            while (rs.next()) {
                ...
                su.setTotalDataNum(rs.getInt("total_data_num"));
...
//            sql += " and cbr.catid1 = ?";
    ...
    public int reDownShopGoods(String shopId, Admuser admuser, String memberId) {
        ...
        String upShopSql = "update shop_url_bak set flag=0,is_valid=0,online_status=0,is_auto = 0," +
                ...
                + ",createtime = now(),is_shop_flag =1,member_id='"+memberId+"',"
