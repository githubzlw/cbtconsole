...
public interface IMoreActionService {
	 ...
	 * @return
	 */
	public int total(int userId, String userName, int start, int end, String email);
	 ...
	 * @return
	 */
	public int dropShiptotal(int userId, String userName, int start, int end, String email);
	 ...
	 * @return
	 */
	public int customOrdertotal(int userId, String userName, int start, int end, String email);
