...
public class ContinueFTP2 extends Thread{
...
//        }else{
//        	out=new FileOutputStream(new String(remoteFile.getBytes("GBK"),"iso-8859-1"));
//        }
//        byte[] bytes = new byte[1024];
//        int c;   
...
//        OutputStream os = null;
        ...
        ftpClient.changeWorkingDirectory(new String(remoteFile.getBytes("GBK"),"iso-8859-1"));
        if(remoteSize>0){   
        	out = ftpClient.appendFileStream(new String(remoteFile.getBytes("GBK"),"iso-8859-1"));   
            ftpClient.setRestartOffset(remoteSize);   
            process = remoteSize /step;   
...
//               this.download(file1, file2); 
                 ContinueFTP2.upload(file2,file1);
                 this.disconnect();   
          } catch (IOException e) {   
