...
public interface MessageNotificationMapper {
	 ...
	 * @return
	 */
	List<MessageNotification> queryForListByAdminId(@Param("adminId") Integer adminId,
	 ...
	 * @return
	 */
	List<MessageNotification> queryForListByType(Integer type);
	 ...
	 * @return
	 */
	List<MessageNotification> queryForListByIsRead(String isRead);
	 ...
	 * @return
	 */
	List<MessageNotification> queryForListByOrderNo(String orderNo);
	 ...
	 * @return
	 */
	MessageNotification queryById(Integer id);
	 ...
	 */
	void insertMessageNotification(MessageNotification messageNotification);
	 ...
	 * @return
	 */
	public List<MessageNotification> getMsgList(@Param("type") Integer type, @Param("isread") String isread,
	 ...
	 * @param senderId
	 */
	public void updateByOrderNoTypeSenderId(@Param("orderNo") String orderNo, @Param("type") int type,
                                            @Param("senderId") int senderId, @Param("message_id") int message_id);
	 ...
	 * @param type
	 */
	public void updateIsReadByUserId(@Param("userId") int userId, @Param("type") int type);
