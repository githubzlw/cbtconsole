...
public class OrderBean implements Serializable {
	...
	private static final long serialVersionUID = -4604872273415719139L;
	private int id;
	private int userid;
  ...
  //订单修改记录数(用于查询显示)
	...
	public OrderBean(int id, String orderNo, int deliveryTime,
			String product_cost, int state, List<SpiderBean> spider,
			String createtime) {
		super();
		this.id = id;
