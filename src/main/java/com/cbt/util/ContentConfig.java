...
public class ContentConfig {
	...
	//图片服务器快照图片下载路径
	public static final String  PICTURE_SERVER_IMG_DOWN ="http://104.247.194.50:8080/cloudimginterface/downLoadCtr/downImg?";
	
	//图片服务器同款1688图片下载路径
	public static final String  PICTURE_SERVER_IMG_1688_DOWN ="http://104.247.194.50:8080/cloudimginterface/downLoadCtr/down1688Img?";
		
	//清理抓取后的程序调用接口
	public static final String  DEAL_1688_GOODS_URL ="http://192.168.1.28:8765/checkimage/clear/sameGoods?";
	
	//图片服务器店铺商品图片下载路径
	public static final String  SHOP_GOODS_IMG_DOWN ="http://104.247.194.50:8080/cloudimginterface/downLoadCtr/downShopImg?";
	
	//图片服务器店铺商品图片打包文件下载路径
	public static final String  SHOP_GOODS_WHOLE_IMG_DOWN ="http://104.247.194.50:8080/cloudimginterface/downLoadCtr/downShopWholeImg?";
	...
	//品类精研图片上传到服务器
	public static final String  CATEGORY_RESEARCH_IMG_DOWN ="http://104.247.194.50:8080/cloudimginterface/downLoadCtr/publicDownWholeImg?";
