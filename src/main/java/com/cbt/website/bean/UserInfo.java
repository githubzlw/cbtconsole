...
public class UserInfo {
	...
	public String getGoodsPriceUrl() {
		return goodsPriceUrl;
	}
	public void setGoodsPriceUrl(String goodsPriceUrl) {
		this.goodsPriceUrl = goodsPriceUrl;
	}
	...
	public String getBind_google() {
		return bind_google;
	}
	public void setBind_google(String bind_google) {
		this.bind_google = bind_google;
	}
	...
	public Float getOrderPriceu() {
		return orderPriceu;
	}
	public void setOrderPriceu(Float orderPriceu) {
		this.orderPriceu = orderPriceu;
	}
