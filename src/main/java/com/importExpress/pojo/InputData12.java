 ...
 * mongodb 更新json数据对象
 */
public class InputData12 {

    private String pid;
    private String img_check;
    private Character crud;
    private String sku_new;// 免邮价最非Pets 免邮价sku区间价
	private String price_import;// 免邮价最低价import
	private String price_kids;// 免邮价最低价Kids
	private String price_pets;// 免邮价最低价Pets
	private String free_price_new;// 免邮价最非Pets
	private String range_price_free_new;// 免邮价最非Pets区间价
