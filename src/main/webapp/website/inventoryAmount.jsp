...
$(function(){
	...
	opts.url = "/cbtconsole/StatisticalReport/getInventoryAmount";
	$("#data").combobox({
...
function doReset(){
  ...
  */
  function exportdata(){
	  ...
	  var times=$("#times").val();
 	 window.location.href ="/cbtconsole/StatisticalReport/exportInventoryAmount?times="+times;
 }
...
<body text="#000000" onload="doQuery(1)">
	<div id="top_toolbar" style="padding: 5px; height: auto">
		...
		<span>【${param.times}】产生库存总金额</span><span style="color:red">￥【${param.amount}】</span>
	</div>
	
		<table class="easyui-datagrid" id="easyui-datagrid"   style="width:2000px;height:900px">
		<thead>	
			<tr>
				<th data-options="field:'goodName',width:25,align:'center'">商品名称</th>
				<th data-options="field:'car_type',width:45,align:'center'">商品规格</th>
				<th data-options="field:'car_img',width:40,align:'center'">商品图片</th>
				<th data-options="field:'inventory_price',width:55,align:'center'">采购价格</th>
				<th data-options="field:'inventory_acount',width:35,align:'center'">库存数量</th>
				<th data-options="field:'invetory_amount',width:35,align:'center'">库存金额</th>
				<th data-options="field:'inventory_barcode',width:40,align:'center'">库存位置</th>
				<th data-options="field:'createtime',width:40,align:'center'">库存时间</th>
			</tr>
		</thead>
	</table>
</body>
