...
<%-- 					<td> 
					...
					<td> 
					  ...
					  <c:if test="${gbb.tbImg1 !=''}">
						 <br> 价格 ${gbb.tbprice }
						 <br> 是否免邮 :<c:if test="${gbb.proCon1==0 }">否</c:if><c:if test="${gbb.proCon1!=0 }"><em style="color:#F00;">是</em></c:if>
					...
					<td> 
					  ...
					  <c:if test="${gbb.tbImg2 !=''}">
						 <br> 价格 ${gbb.tbprice1 }
						 <br> 是否免邮 :<c:if test="${gbb.proCon2==0 }">否</c:if><c:if test="${gbb.proCon2!=0 }"><em style="color:#F00;">是</em></c:if>
					...
					<td> 
					  ...
					  <a id="a4" href="https://detail.1688.com/offer/${gbb.goodsName3}.html" target="_blank">
						...
						<c:if test="${gbb.tbImg3 !=''}">
						 <br> 价格 ${gbb.tbprice2 }
						 <br> 是否免邮 :<c:if test="${gbb.proCon3==0 }">否</c:if><c:if test="${gbb.proCon3!=0 }"><em style="color:#F00;">是</em></c:if>
					...
					<td> 
					  ...
					  <c:if test="${gbb.tbImg4 !=''}">
						 <br> 价格 ${gbb.tbprice3 }
						 <br> 是否免邮 :<c:if test="${gbb.proCon4==0 }">否</c:if><c:if test="${gbb.proCon4!=0 }"><em style="color:#F00;">是</em></c:if>
					...
					<td> 
					  ...
					  <a id="a6" href="https://detail.1688.com/offer/${gbb.goodsName5}.html" target="_blank">
						...
						<c:if test="${gbb.tbImg5 !=''}">
						 <br> 价格 ${gbb.tbprice4 }
						 <br> 是否免邮 :<c:if test="${gbb.proCon5==0 }">否</c:if><c:if test="${gbb.proCon5!=0 }"><em style="color:#F00;">是</em></c:if>
					...
					<td> 
					  ...
					  <c:if test="${gbb.tbImg6 !=''}">
						 <br> 价格 ${gbb.tbprice5 }
						 <br> 是否免邮 :<c:if test="${gbb.proCon6==0 }">否</c:if><c:if test="${gbb.proCon6!=0 }"><em style="color:#F00;">是</em></c:if>
