									...
									<tr  onmouseover="buttonMouseover('${storageLocation.user_id }','${storageLocation.order_no }') "  id="trid${storageLocation.order_no }">
										...
										<td width="20%"><font style="font-size : 15px;">${storageLocation.order_no } </font>
											<c:if test="${storageLocation.sampleOrder > 0}">
												<b style="color: red;">存在免费送样订单${storageLocation.order_no}_SP</b>
											</c:if>
										...
										<c:if test="${strOrderT == 0}">
											...
											<c:if test="${storageLocation.mergestate =='0'}">
												<td id="rowspanid${strOrder }">
                                                    <span style="color:red;">客户默认不合并</span>
                                                    <br>
                                                    <input id="inputid${strOrder }" type="button" onclick="mergeOrders()" class='classSh' value="合并"/>
                                                </td>
