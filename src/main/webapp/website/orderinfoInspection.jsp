...
<div id="div_show">
	...
	<div align="center" >
		...
		<%  if(!(user.getId() ==1 || user.getAdmName().equalsIgnoreCase("Ling") || user.getAdmName().equalsIgnoreCase("emmaxie") || user.getAdmName().equalsIgnoreCase("admin1") || user.getAdmName().equalsIgnoreCase("kara"))){%>
		<!-- 载入消息提醒jsp页面 -->
