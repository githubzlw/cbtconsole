...
<script type="text/javascript">
	$(function() {
		...
		opts.url = "/cbtconsole/warehouse/getShopManager";
	})
	...
	<div id="top_toolbar" style="padding: 5px; height: auto">
		<div>
			<form id="query_form" action="#" onsubmit="return false;" style="margin-left:450px;">
				<input class="easyui-textbox" name="shop_name" id="shop_name" style="width:15%;"  data-options="label:'店铺名称:'">
				<select class="easyui-combobox" name="remark" id="remark" style="width:15%;" data-options="label:'店铺状态:',panelHeight:'auto'">
