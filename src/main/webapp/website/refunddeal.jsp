...
<c:if test="${roletype=='0' || roletype=='3' || roletype=='4'}">
	<div class="col-xs-1">
		<c:if test="${admName=='emmaxie' || admName=='Ling' || admName=='admin1'}">
	...
	<div class="main" align="center">
		...
		<div class="row" style="margin-bottom: 20px;">
			...
			<c:if test="${admName=='Ling' || admName=='emmaxie' || admName=='admin1'}">
				<div class="col-xs-1">
					<button type="reset" class="btn btn-primary btn-sm"
					...
					<tr style="max-height: 200px;"
						...
						<td>
							<div style="position:relative;">
								...
								<c:if test="${roletype=='0'}">
									<c:if test="${(refund.status== 1 || refund.status== -1) && admName=='Ling' && admName=='emmaxie' && admName=='admin1'}">
											<textarea
													style="min-height: 72px;  max-height: 80%;width: 300px;line-height: 15px; float: left;"
													id="remark_${refund.id}"></textarea>
										<div class="remark_sty">
