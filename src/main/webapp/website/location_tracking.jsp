...
$(function(){
	...
	opts.url = "/cbtconsole/warehouse/getLocationTracking";
})
...
<body onload="doQuery(1)">
		...
		<thead>	
			<tr>
				<th data-options="field:'barcode',width:50,align:'center'">库位编号</th>
				<th data-options="field:'short_term',width:30,align:'center'">库位类型</th>
					<th data-options="field:'admuser',width:50,align:'center'">操作人</th>
				<th data-options="field:'createtime',width:30,align:'center'">操作时间</th>
			</tr>
		</thead>
	</table>
</body>
