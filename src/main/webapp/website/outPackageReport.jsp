			...
			<div class="box box-solid" >
				...
				<div class="box-body">
					...
					<div  style="padding:15px;">
			         <label >出库包裹数量统计：</label>
			         <table id="outpackageReport" class="imagetable">
		                   <thead>
		                      <tr>
		                        <th width="100" >序号</th>
		                        <th width="150" >月份</th>
							    <th width="150" >出库数量(个)</th>
		                      </tr>
		                  </thead>
		                  <tbody></tbody>
					</table><br/>
...
$("#pgSearch").click(function(){
	...
	$("#outpackageReport tbody").html("");
	$.ajax({
		url : "/cbtconsole/StatisticalReport/selectOutPackCount?startdate="+startdate+"&enddate="+enddate+"&rand="+Math.random(),
		type:"POST",
		dataType: "json",
		success: function(data){
			...
			var list = data.data;
				for(var i=0;i<list.length;i++){
					$("#outpackageReport tbody").append("<tr><td>"+(i+1)+"</td>"+
							"<td>"+list[i].years+"年"+list[i].mon+"月</td>"+
							"<td>"+list[i].num+"</td>"+
							"</tr>");
				}
			}else{
				$("#outpackageReport tbody").append("<tr><td colspan='6' style='text-align:center;color:red;'>没有数据</td></tr>");
			}
		},
