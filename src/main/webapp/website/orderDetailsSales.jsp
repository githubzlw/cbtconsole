...
$(function(){
	...
	opts.url = "/cbtconsole/StatisticalReport/orderDetetailsSale";
	 $("#dd").datebox({
	...
	<div id="top_toolbar" style="padding: 5px; height: auto">
		<div>
			<form id="query_form" action="#" onsubmit="return false;" style="margin-left:500px;">
				 时间条件:<input id="dd" type="text" class="easyui-datebox">
		...
		<thead>	
			<tr>
				<th data-options="field:'times',width:25,align:'center'">支付日期</th>
				<th data-options="field:'totalSum',width:40,align:'center'">非取消订单总进账(TT+PayPal)</th>
				<th data-options="field:'titalRefund',width:40,align:'center'">总退款</th>
				<th data-options="field:'balancePayment',width:45,align:'center'">余额支付</th>
				<th data-options="field:'balancePrepaid',width:45,align:'center'">余额充值</th>
				<th data-options="field:'salesAmount',width:45,align:'center'">进账对应销售额</th>
				<th data-options="field:'cancelBeforeOrderAmount',width:45,align:'center'">取消的非当日订单对应的销售额</th>
			</tr>
		</thead>
	</table>
</body>
