				...
				<li style="width:280px;float:left;margin:10px;" id="tr${i.index}">
					<div style="border:1px solid #777;padding:10px;position:relative;height:330px;">
						<a target='_blank' href="${gbb.newUrl }" >
								<img  width='200px' title="" height='200px;' src="${gbb.newImg }">
							</a>
							<br>
							${gbb.newName }
							<br>
							...
							Add to supply of goods：
							<input type="checkbox" class="checkbox"id="check${i.index}"
					              	onclick="fnadd('check${i.index}','${gbb.newUrl }','${gbb.newName }','${gbb.newPrice }','${gbb.newImg }','${gbb.aligSourceUrl}','${gbb.goodsDataId}','${gbb.orderNo}')" style="width: 20px;height: 20px;">
					</div>
				</li>
			</c:forEach>
		</ul>
