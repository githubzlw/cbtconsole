...
// 			collapsible : true,//显示可折叠按钮
			...
			url : '/cbtconsole/warehouse/monthSalesEffortsList',//url调用Action方法
			loadMsg : '数据装载中......',
...
<body text="#000000">
	<div id="top_toolbar" style="padding: 5px; height: auto">
		...
		<thead>	
			<tr>
				<th data-options="field:'datas',width:'100px',align:'center'">日期</th>
				<th data-options="field:'admName',width:'100px',align:'center'">负责人</th>
				<th data-options="field:'salesAcount',width:'100px',align:'center'">贡献销售的产品数量</th>
				<th data-options="field:'salesAmount',width:'60px',align:'center'">贡献的销售额($)</th>
				<th data-options="field:'searchAcount',width:'60px',align:'center'">获得的搜索中展示次数</th>
				<th data-options="field:'openAcount',width:'60px',align:'center'">获得的产品打开次数</th>
			</tr>
		</thead>
	</table>
</body>
