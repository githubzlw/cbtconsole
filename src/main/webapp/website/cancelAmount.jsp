...
function doReset(){
  ...
  */
  function exportdata(){
	  var times=$("#times").val();
	  var userName=$('#userName').combobox('getValue');
 	 window.location.href ="/cbtconsole/StatisticalReport/exportBuyOrderDetails?times="+times+"&userName="+userName+"&type=2";
 }
