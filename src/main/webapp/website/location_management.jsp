...
<div id="top_toolbar" style="padding: 5px; height: auto">
    <div>
        <form id="query_form" action="#" onsubmit="return false;">
				<span>库位类型:<select id="location_type" style="width:80px;height: 26px;">
				<option value="-1" selected>全部</option>
				<option value="1">中期库</option>
				<option value="0">今明库</option>
				</select> </span>
            &nbsp;&nbsp;&nbsp;<span>库位地址:<select id="location" style="width:80px;height: 26px;">
				<option value="-1" selected>全部</option>
				<option value="1">公司库位</option>
				<option value="2">仓库库位</option>
				</select></span>
            &nbsp;&nbsp;&nbsp;<span>库位选项:<select id="is_empty" style="width:90px;height: 26px;">
				<option value="-1" selected>全部</option>
				<option value="1">库位不为空</option>
				<option value="0">库位为空</option>
				</select></span>
            &nbsp;&nbsp;&nbsp;<span>订单号:<input name="orderid" id="orderid" style="width:180px;height: 26px;"
                             onkeypress="if (event.keyCode == 13) doQuery(1)"></span>
            &nbsp;&nbsp;&nbsp;<span>运单号:<input name="shipno" id="shipno" style="width:200px;height: 26px;"
                             onkeypress="if (event.keyCode == 13) doQuery(1)"></span>
            &nbsp;&nbsp;&nbsp;<span>PID:<input name="shipno" id="query_pid" style="width:160px;height: 26px;"
                             onkeypress="if (event.keyCode == 13) doQuery(1)"></span>
            &nbsp;&nbsp;&nbsp;<span>库位码:<input value="如:GS271" name="barcode" id="barcode" style="width:140px;height: 26px;"></span>
            &nbsp;&nbsp;&nbsp;<span><input class="but_color" type="button" value="查询" onclick="doQuery(1)"> </span>
            &nbsp;&nbsp;&nbsp;<span><input class="but_color" type="button" value="重置" onclick="doReset()"></span>
        </form>
        <p style="text-align: right"><a href="/cbtconsole/website/ReturnDisplay.jsp" target='_blank'
                                        style=" color:green; font-size:20px;">退货管理页面</a></p>
    </div>
    中期库[<span id="zhongqi">${sessionScope.mid_barcode}</span>]个空位 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;今明库[<span
        id="duanqi">${sessionScope.shortTerm}</span>]个空位
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已验货-待出库:<a target="_blank" href="/cbtconsole/website/order_library.jsp"
                                             target="blank"><span id="noInspection">${sessionScope.noInspection}</span></a>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已全到库-待验货:<a target="_blank" href="/cbtconsole/website/all_library.jsp" target="blank"><span
        id="allLibrary">${sessionScope.allLibrary}</span></a>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有待确认使用库存的商品:<a
        href="/cbtconsole/PurchaseServlet?action=getStockOrderInfo&className=Purchase&pagenum=1&orderid=0"
        target="blank"><span style="color:red;" id="stockOrderInfo">${sessionScope.stockOrderInfo}</span></a>
