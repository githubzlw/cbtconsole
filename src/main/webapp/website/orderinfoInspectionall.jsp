...
<input type="hidden" id="delImgsOrderid"/>
	...
	<div align="center" >                                                                 
		<div id="dddd"></div>
		<div><H1>商品出库审核  <a href="/cbtconsole/warehouse/getOrderInfoInspection.do" style="font-size: 14px">当前查全部,点击返回原版</a></H1>
			<div id="showimg"></div>
		</div>        
		                                   
		<div id="gdwzdiv">
			<form id="idForm" action="getOrderInfoInspectionall.do" method="GET">
			...
			<select size="4" id="selStruts" style="background-color: #F445FF4"  onchange="window.location=this.value" >
				<option id='selStruts1' value='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=1&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}'>未审核</option>
				<option id='selStruts2' value='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=2&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}'>已通过</option>
				<option id='selStruts3' value='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=3&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}'>有问题</option>
				<option id='selStruts0' selected="selected" value='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=0&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}'>所有</option>
			</select>
			...
			<select id="selDate" size="4"  style="background-color: #F445FF4"  onchange="window.location=this.value" >
				...
				<option id="selDate"  selected="selected" 
				                            value='getOrderInfoInspectionall.do?orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts}&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}'>不限时间</option>
				<option id="selDate1" value='getOrderInfoInspectionall.do?day=1&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts}&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}'>一天以内</option>
				<option id="selDate3" value='getOrderInfoInspectionall.do?day=3&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts}&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}'>三天以内</option>
				<option id="selDate7" value='getOrderInfoInspectionall.do?day=7&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts}&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}'>一周以内</option>
		    ...
		    <select id="selOrderPositon" size="3"  style="background-color: #F445FF4"  onchange="window.location=this.value" >
				<option id="selorder0"  selected="selected" 
				                            value='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts}&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}&orderPosition=0'>所有订单</option>
				
				<option  id="selorder1"  value='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts}&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}&orderPosition=1'>公司订单</option>
				<option  id="selorder2" value='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts}&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}&orderPosition=2'>仓库订单</option>
			</select>
			<script type="text/javascript">
	...
	<%  if(!(user.getId() ==1 || user.getAdmName().equalsIgnoreCase("Ling") || user.getAdmName().equalsIgnoreCase("emmaxie") || user.getAdmName().equalsIgnoreCase("kara") || user.getAdmName().equalsIgnoreCase("admin1"))){%>
		<!-- 载入消息提醒jsp页面 -->
	...
	<%}  %>
								...
								<tr  onmouseover="buttonMouseover('${storageLocation.user_id }','${storageLocation.order_no }') "  id="trid${storageLocation.order_no }">
										...
										<c:if test="${strOrderT == 0}">
											<c:if test="${storageLocation.mergestate =='1'}">
											  <td id="rowspanid${strOrder }"><input id="inputid${strOrder }" type="button" onclick="updateHb('${storageLocation.mergeOrders}')" class='classSh' value="取消合并"/></td>
											</c:if>
											<c:if test="${storageLocation.mergestate =='0'}">
											  <td id="rowspanid${strOrder }"><input id="inputid${strOrder }" type="button" onclick="mergeOrders()" class='classSh' value="合并"/></td>
		...
		<div>
			<select class='classSelect' onchange="window.location=this.value" >
				<option selected="selected" value='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts }&pageNum=${oip.previousPage }&pageSize=${oip.pageSize}'>每页显示${oip.pageSize}条</option>
				
				<c:forEach begin="1" end="3" var="i">
					<c:if test="${i*50 != oip.pageSize}">
						<option value='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts }&pageNum=${oip.previousPage }&pageSize=${i*50 }'> 每页显示${i*50}条</option>
					</c:if>
				</c:forEach>
				
			</select>
			 <a href='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts }&pageNum=1&pageSize=${oip.pageSize }' class='className'>第一页</a>
			 <a href='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts }&pageNum=${oip.previousPage }&pageSize=${oip.pageSize }' class='className'>上一页</a>
			 <a href='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts }&pageNum=${oip.nextPage }&pageSize=${oip.pageSize }' class='className'>下一页</a>
			 <a href='getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts }&pageNum=${oip.pageCount }&pageSize=${oip.pageSize }' class='className'>最后一页</a>
		</div>
		<div>
	...
	<a href="getOrderInfoInspectionall.do?day=${oip.day}&orderid=${oip.orderid}&userid=${oip.userid }&orderstruts=${oip.orderstruts }&pageNum=${oip.previousPage }&pageSize=${oip.pageSize }"><span id="spanId"></span></a>
