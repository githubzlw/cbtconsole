	...
	<div id="top_toolbar" style="padding: 5px; height: auto">
		...
		<thead>	
			<tr>
				...
				<th data-options="field:'applyUser',width:20,align:'center'">申请人员</th>
				<th data-options="field:'returnNumber',width:20,align:'center'">退货数量</th>
				<th data-options="field:'pepoInfo',width:50,align:'center'">最终状态</th>
