...
// 			collapsible : true,//显示可折叠按钮
			...
			url : '/cbtconsole/StatisticalReport/searchGoodsInventoryUpdateInfo',//url调用Action方法
			loadMsg : '数据装载中......',
...
//导出数据
	function exportUpdateInventoryExcel(){
        var barcode =$('#have_barcode').combobox('getValue');
        var admName =$('#admName').combobox('getValue');
        var startdate = $("#startdate").val();
        var enddate = $("#enddate").val();
        ...
        window.location.href ="/cbtconsole/StatisticalReport/exportUpdateInventoryExcel?barcode="+barcode+"&admName="+admName+"&startdate="+startdate+"&enddate="+enddate;
	}
	...
	<div id="top_toolbar" style="padding: 5px; height: auto">
		<div>
			<form id="query_form" action="#" onsubmit="return false;">
	           <select class="easyui-combobox" name="have_barcode" id="have_barcode" style="width:12%;" data-options="label:'盘点前库位:',panelHeight:'400px',valueField: 'barcode',   
                    textField: 'barcode', value:'全部',selected:true,
                    url: '/cbtconsole/StatisticalReport/getHavebarcode',  
                    method:'get'">
				</select>
				<select class="easyui-combobox" name="admName" id="admName" style="width:10%;height: 30px;" data-options="label:'盘点人:',panelHeight:'auto'">
		...
		<a href="javascript:exportUpdateInventoryExcel();" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">导出</a>
	</div>
		...
		<thead>	
			<tr>
				...
				<th data-options="field:'car_img',width:50,align:'center'">商品图片</th>
				<th data-options="field:'sku',width:50,align:'center'">商品规格</th>
				<th data-options="field:'goods_p_price',width:50,align:'center'">采购价格</th>
				<th data-options="field:'old_inventory',width:20,align:'center'">盘点前数量</th>
				<th data-options="field:'new_inventroy',width:20,align:'center'">盘点后数量</th>
				<th data-options="field:'old_barcode',width:30,align:'center'">盘点前库位</th>
				<th data-options="field:'new_barcode',width:40,align:'center'">盘点后库位</th>
				<th data-options="field:'admName',width:40,align:'center'">盘点人</th>
				<th data-options="field:'createtime',width:50,align:'center'">盘点时间</th>
				<th data-options="field:'remark',width:50,align:'center'">盘点备注</th>
			</tr>
		</thead>
	</table>
</body>
