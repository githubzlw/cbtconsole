...
<head>
	...
	<script type="text/javascript">
        $(function(){
            ...
            opts.url = "/cbtconsole/StatisticalReport/getNoStorageDetails";
        })

        function setDatagrid() {
            $('#easyui-datagrid').datagrid({
                title : '发货三天未入库订单详情(单位:RMB)',
                //iconCls : 'icon-ok',
                width : "100%",
                fit : true,//自动补全
...
<div id="top_toolbar" style="padding: 5px; height: auto">
	<div>
		<form id="query_form" action="#" onsubmit="return false;" style="margin-left:500px;">
			<input class="easyui-textbox"  name="orderNo" id="orderNo" style="width:18%;"  data-options="label:'订单号:'">
