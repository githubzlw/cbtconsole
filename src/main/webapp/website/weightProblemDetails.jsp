...
$(function(){
    ...
    opts.url = "/cbtconsole/warehouse/weightProblemDetails";
...
<body text="#000000" onload="doQuery(1)">
	<div id="top_toolbar" style="padding: 5px; height: auto;display: none">
		...
		<thead>	
			<tr>
				<th data-options="field:'pid_1688',width:'80px',align:'center'">1688_pid</th>
				<th data-options="field:'ali_pid',width:'80px',align:'center'">ali_pid</th>
				<th data-options="field:'weight1688',width:'35px',align:'center'">1688weight</th>
				<th data-options="field:'ali_weight',width:'35px',align:'center'">ali_weight</th>
				<th data-options="field:'moq1688',width:'35px',align:'center'">1688moq</th>
				<th data-options="field:'price1688',width:'35px',align:'center'">1688price</th>
				<th data-options="field:'name1688',width:'120px',align:'center'">1688_name</th>
				<th data-options="field:'ali_name',width:'120px',align:'center'">ali_name</th>
				<th data-options="field:'category1688',width:'60px',align:'center'">1688_category</th>
				<th data-options="field:'ali_category',width:'60px',align:'center'">ali_category</th>
				<th data-options="field:'problem_type',width:'60px',align:'center'">problem_type</th>
				<th data-options="field:'publish_time',width:'60px',align:'center'">publish_time</th>
				<th data-options="field:'edit_time',width:'60px',align:'center'">edit_time</th>
				<th data-options="field:'user',width:'60px',align:'center'">user</th>
			</tr>
		</thead>
	</table>
</body>
