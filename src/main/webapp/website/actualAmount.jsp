...
$(function(){
	...
	opts.url = "/cbtconsole/StatisticalReport/getPayFreight";
	$("#data").combobox({
...
function doReset(){
  ...
  */
  function exportdata(){
	  ...
	  var times=$("#times").val();
 	 window.location.href ="/cbtconsole/StatisticalReport/exportForecastAmount?times="+times+"&orderid="+orderid+"&type=2";
 }
...
<body text="#000000" onload="doQuery(1)">
	<div id="top_toolbar" style="padding: 5px; height: auto">
		<div>
			<form id="query_form" action="#" onsubmit="return false;" style="margin-left:500px;">
				<div style="margin-bottom:20px">
					<input class="easyui-textbox"  name="orderNo" id="orderNo" style="width:18%;"  data-options="label:'出运单号:'">
		...
		<span>【${param.times}】上传实际运费总金额</span><span style="color:red">￥【${param.amount}】</span>
	</div>
	
		<table class="easyui-datagrid" id="easyui-datagrid"   style="width:2000px;height:900px">
		<thead>	
			<tr>
				<th data-options="field:'orderno',width:25,align:'center'">运单单号</th>
				<th data-options="field:'senttimes',width:40,align:'center'">出运时间</th>
				<th data-options="field:'country',width:55,align:'center'">出运国家</th>
				<th data-options="field:'transportcompany',width:35,align:'center'">运输公司</th>
				<th data-options="field:'transporttype',width:35,align:'center'">运输方式</th>
				<th data-options="field:'type',width:40,align:'center'">包裹类型</th>
				<th data-options="field:'realweight',width:45,align:'center'">实际重量</th>
				<th data-options="field:'bulkweight',width:45,align:'center'">体积重量</th>
				<th data-options="field:'settleweight',width:45,align:'center'">结算重量</th>
				<th data-options="field:'totalprice',width:30,align:'center'">运费金额</th>
			</tr>
		</thead>
	</table>
</body>
