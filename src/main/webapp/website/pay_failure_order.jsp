...
// 			collapsible : true,//显示可折叠按钮
			...
			url : '/cbtconsole/StatisticalReport/getPayFailureOrder',//url调用Action方法
			loadMsg : '数据装载中......',
	...
	<div id="top_toolbar" style="padding: 5px; height: auto">
		...
		<thead>	
			<tr>
				...
				<th data-options="field:'paySID',width:50,align:'center'">paySID</th>
				<th data-options="field:'per_payprice',width:15,align:'center'">付款金额($)</th>
				<th data-options="field:'payment_method_nonce',width:50,align:'center'">payapl密钥</th>
				<th data-options="field:'message',width:50,align:'center'">支付失败原因</th>
				<th data-options="field:'createtime',width:30,align:'center'">支付失败时间</th>
				<th data-options="field:'description',width:80,align:'center'">备注信息</th>
			</tr>
		</thead>
	</table>
</body>
