...
<script type="text/javascript">
	...
	function getCodeId(value){
		window.location = "${path}/customerServlet?action=findAllPicture&className=PictureComparisonServlet&cid="+value;
	}
...
/* 	function fnSave(){
		...
		for(var i=0;i<ary.length;i++){
			...
			$.post("${path}/customerServlet?action=pageSaveTbgooddata&className=PictureComparisonServlet",
					{pId:pId,tbId:tbId},
					function(res){
						if(res>0){
							//alert("保存成功");
		...
		//alert("保存成功");
		//window.open("${path}/customerServlet?action=findAllPicture&className=PictureComparisonServlet");
		window.open("${path}/customerServlet?action=findAllPicture&className=PictureComparisonServlet&page="+page);
		//window.location.href("${path}/customerServlet?action=findAllPicture&className=PictureComparisonServlet&page="+page);
	...
	function fnSave(){
		...
		for(var i=1;i<s;i++){
 		...
 		for(var i=0;i<ary.length;i++){
			...
			$.post("${path}/customerServlet?action=updateCacheFlag&className=PictureComparisonServlet",
					{url:gbbUrl,flag:1},
					function(res){
						if(res>0){
							//alert("保存成功");
		...
		window.open("${path}/customerServlet?action=findPictureCompare&className=PictureComparisonServlet&page="+page);
	}
	
	function fnSelectInfo(){
		window.location = "${path}/customerServlet?action=findAllTaoBaoInfo&className=PictureComparisonServlet";
	...
	function FnStart5(){
		$.ajax({
			async: false, 
			type:'POST',
			url:'${path}/customerServlet?action=pictureCompare&className=PictureComparisonServlet',
			data:{flag:'5'},
...
<div align="center">
<div>
	&nbsp;&nbsp;&nbsp;&nbsp;<input onclick="FnStart5()" type="button" value="汉明距离5">
</div>
<%-- 	<form action="${path}/customerServlet?action=findAllPicture&className=PictureComparisonServlet" onsubmit="return check();" method="post">
		<table>
			<tr>
				<td>相似度:
...
<!-- 				<th>淘宝产品2</th>
			...
			<c:forEach items="${gbbs }" var="gbb" varStatus="i">
				<Tr class="a" id="tr${i.index}">
					<td id="canl${i.index}"> 
						<img  width='200px' title="" height='200px;' src="${gbb.aliSourceImgUrl }" style='cursor: pointer;' >
...
<%-- 					 	<c:forEach items="${gbb.aliStyleList }" var="aliStys">
					...
					<%-- 	<input type="hidden" id="aligSourceUrl" value="${gbb.aligSourceUrl}"> --%>
					 ...
					 <td> 
						<img  width='200px' title="${gbb.tbName}" height='200px;' src="${gbb.tbImg }"  style="cursor: pointer;border:6px solid red" 
							...
							<br /><a target='_blank' href="${gbb.tbUrl}" class="a1" >Info</a>
					...
					<%-- <td>
						<br />FCTH相似度:${gbb.score }
								<br /><img  width='150px' title="" height='150px;' src="http://192.168.1.26${gbb.tbPath }"  style="cursor: pointer;" >
								<br />FCTH相似度:${gbb.score_1 }
								<br /><img  width='150px' title="" height='150px;' src="http://192.168.1.26${gbb.tbPath_1 }"  style="cursor: pointer;" >
								<br />FCTH相似度:${gbb.score_2 }
								<br /><img  width='150px' title="" height='150px;' src="http://192.168.1.26${gbb.tbPath_2 }"  style="cursor: pointer;" >
								<br />FCTH相似度:${gbb.score_3 }
								<br /><img  width='150px' title="" height='150px;' src="http://192.168.1.26${gbb.tbPath_3 }"  style="cursor: pointer;" >
								
					</td>
					<td>
						<br />CEDD相似度:${gbb.score1 }
						<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath1 }"  style="cursor: pointer;" >
						<br />CEDD相似度:${gbb.score1_1 }
						<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath1_1 }"  style="cursor: pointer;" >
						<br />CEDD相似度:${gbb.score1_2 }
						<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath1_2 }"  style="cursor: pointer;" >
						<br />CEDD相似度:${gbb.score1_3 }
						<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath1_3 }"  style="cursor: pointer;" >
					</td>
					<td>
							<br />ColorLayout相似度:${gbb.score2 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath2 }"  style="cursor: pointer;" >
								<br />ColorLayout相似度:${gbb.score2_1 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath2_1 }"  style="cursor: pointer;" >
								<br />ColorLayout相似度:${gbb.score2_2 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath2_2 }"  style="cursor: pointer;" >
								<br />ColorLayout相似度:${gbb.score2_3 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath2_3 }"  style="cursor: pointer;" >
					</td>
					<td>
						<br />EdgeHistogram相似度:${gbb.score3 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath3 }"  style="cursor: pointer;" >
								<br />EdgeHistogram相似度:${gbb.score3_1 }
								<br /><img  width='100px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath3_1 }"  style="cursor: pointer;" >
								<br />EdgeHistogram相似度:${gbb.score3_2 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath3_2 }"  style="cursor: pointer;" >
								<br />EdgeHistogram相似度:${gbb.score3_3 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath3_3 }"  style="cursor: pointer;" >
					</td>
					<td>
						<br />AUTOColor相似度:${gbb.score4 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath4 }"  style="cursor: pointer;" >
								<br />AUTOColor相似度:${gbb.score4_1 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath4_1 }"  style="cursor: pointer;" >
								<br />AUTOColor相似度:${gbb.score4_2 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath4_2 }"  style="cursor: pointer;" >
								<br />AUTOColor相似度:${gbb.score4_3 }
								<br /><img  width='150px' title="" height='150px' src="http://192.168.1.26${gbb.tbPath4_3 }"  style="cursor: pointer;" >
					</td>
								 --%>
...
<%-- 					<c:forEach items="${gbb.pictureList}" var="cl" varStatus="j">
		...
		<!-- <div style="width:180px; margin:auto;" >
 	 	...
 	 	<%-- 	<a href="${path}/customerServlet?action=findAllTaoBaoInfo&className=PictureComparisonServlet" target="_blank" >已保存数据</a> --%>
 	 	</div>
