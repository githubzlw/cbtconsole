...
<div align="center">
	<form action="/cbtconsole/customerServlet?action=findAllStockNearby&className=MoreActionServlet" onsubmit="return check();" method="post">
		<table>
			<tr>
	...
	<div>
		<table id="table" align="center" border="1px" style="font-size: 13px;" width="800" bordercolor="#8064A2" cellpadding="0" cellspacing="0" >
			...
			<Tr>
				...
				<td>${gbb.orderFrequency }</td>
				<td>${gbb.orderQuantity }</td>
				<td style="word-break: break-all;">${gbb.companyName }</td>
				<td>${gbb.annualTurnover }</td>
