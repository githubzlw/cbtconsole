...
<div align="center">
	<form action="/cbtconsole/customerServlet?action=findAllPriceMatch&className=MoreActionServlet" onsubmit="" method="post">
		<table>
			<tr>
...
<%-- 			<Tr>
			...
			<Tr>
				...
				<th>date</th>
				<th>product</th>
				<th>Other Products' URL</th>
				<th>The Price you get from them</th>
			...
			<Tr>
				...
				<td>${gbb.createTime }</td>
				<td><a href="/cbtconsole/processesServlet?action=getSpider&className=SpiderServlet&amp;url=${gbb.purl }" >${gbb.purl }</a></td>
				<td><a href="${gbb.otherUrl }" >${gbb.otherUrl }</a></td>
				<td>${gbb.fromPrice }</td>
				<td>${gbb.quantity }</td>
				<td>
