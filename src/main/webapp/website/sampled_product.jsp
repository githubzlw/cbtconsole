...
<% 
  String goods_pids=request.getParameter("pids");
%>
<script type="text/javascript">
$(function(){
	setDatagrid();
...
// 			collapsible : true,//显示可折叠按钮
			...
			url : '/cbtconsole/StatisticalReport/searchSampleProduct',//url调用Action方法
			loadMsg : '数据装载中......',
...
<!-- 				 <input class="but_color" type="button" value="重置" onclick="doReset()"> -->
		...
		<thead>	
			<tr>
				<th data-options="field:'orderNo',width:50,align:'center'">订单号</th>
				<th data-options="field:'detailsNumber',width:50,align:'center'">商品数量</th>
				<th data-options="field:'deliveryTime',width:50,align:'center'">生成时间</th>
				<th data-options="field:'actualLwh',width:50,align:'center'">采购人</th>
			</tr>
		</thead>
	</table>
</body>
