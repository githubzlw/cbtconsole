...
<div align="center">
	<form action="/cbtconsole/customerServlet?action=findAllCustomRfq&className=MoreActionServlet" onsubmit="" method="post">
		<table>
			<tr>
...
<%-- 			<Tr>
			...
			<Tr>
				...
				<th>Photo</th>
				<th>Product Name</th>
				<th>Your planned order quantity</th>
				<th>comments</th>
				<th>state</th>
				<!-- <th>quantity</th>
				<th>comment</th>
			...
			<Tr>
				...
				<td> <img  width='100px' title="" height='100px;' src="${pageContext.request.contextPath}/searchupload/${gbb.photo }" style='' ></td>
