...
// 			collapsible : true,//显示可折叠按钮
			...
			url : '/cbtconsole/StatisticalReport/searchLossInventoryInfo',//url调用Action方法
			loadMsg : '数据装载中......',
...
//导出库存删除日志
function exportLossInventoryExcel(){
    ...
    window.location.href ="/cbtconsole/StatisticalReport/exportLossInventoryExcel?barcode="+barcode+"&admName="+admName+"&startdate="+startdate+"&enddate="+enddate;
}
...
<body onload="doQuery('1')">
	...
	<div id="top_toolbar" style="padding: 5px; height: auto">
		...
		<a href="javascript:exportLossInventoryExcel();" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">导出</a>
	</div>
		<table class="easyui-datagrid" id="easyui-datagrid"   style="width:1200px;height:900px">
		<thead>	
			<tr>
				<th data-options="field:'old_remaining',width:50,align:'center'">盘点前库存</th>
				<th data-options="field:'new_remaining',width:50,align:'center'">盘点后库存</th>
				<th data-options="field:'old_barcode',width:80,align:'center'">盘点前库位</th>
				<th data-options="field:'new_barcode',width:80,align:'center'">盘点后库位</th>
				<th data-options="field:'sku',width:50,align:'center'">商品规格</th>
				<th data-options="field:'car_img',width:80,align:'center'">商品图片</th>
				<th data-options="field:'loss_price',width:50,align:'center'">损耗单价</th>
				<th data-options="field:'loss_amount',width:60,align:'center'">损耗库存金额</th>
				<th data-options="field:'createtime',width:40,align:'center'">损耗时间</th>
				<th data-options="field:'admName',width:50,align:'center'">损耗人</th>
				<th data-options="field:'remark',width:40,align:'center'">损耗原因</th>
			</tr>
		</thead>
	</table>
</body>
